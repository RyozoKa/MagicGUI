...
UINT64 RoundUp(UINT64 number, UINT64 multiple)
{
	UINT64 remainder = number % multiple;
	if (remainder == 0)
		return number;
	return number + multiple - remainder;
}

UINT64 StaticPow10(BYTE num)
{
...
void decode(UINT output[], const BYTE input[], size_type len)
{
...
void encode(BYTE output[], const UINT input[], size_type len)
{
